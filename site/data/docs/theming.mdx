...
You can tweak the KlayKit UI to match your branding. You can pick from a few pre-defined accent colors and border radius configurations.
...
```tsx
import { RainbowKitProvider, darkTheme } from 'klaykit';
...
```tsx
import { RainbowKitProvider, midnightTheme } from 'klaykit';
...
```tsx
import { RainbowKitProvider, lightTheme } from 'klaykit';
...
```tsx
import { RainbowKitProvider, lightTheme, darkTheme } from 'klaykit';
